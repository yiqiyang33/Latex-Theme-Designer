...
\newcommand{\ThemeBeginDefinition}[1]{%
...
\newcommand{\ThemeBeginCorollary}[1]{%
    \if\relax\detokenize{#1}\relax
        \begin{corollary}%
    \else
        \begin{corollary}[#1]%
...
\newcommand{\ThemeBeginProposition}[1]{%
    \if\relax\detokenize{#1}\relax
        \begin{proposition}%
    \else
        \begin{proposition}[#1]%
...
\newcommand{\ThemeBeginAssumption}[1]{%
    \if\relax\detokenize{#1}\relax
        \begin{assumption}%
    \else
        \begin{assumption}[#1]%
...
\else
    ...
    {
        theorem/variant={axiom-body-bg}{axiom-title-bg}{axiom-accent}{axiom-title-fg},
    }{axiom}
\fi
...
\ifEnablePlainAmsthmTheorem
    ...
    \newcommand{\ThemeAssumptionCommand}[3]{
        \ThemeBeginAssumption{#1}
            \ThemeEmitPrefixedLabel{assump}{#2}
            #3
        \end{assumption}
    }

    \newcommand{\ThemeAxiomCommand}[3]{
        \ThemeBeginAxiom{#1}
            \ThemeEmitPrefixedLabel{axiom}{#2}
            #3
        \end{axiom}
    }
    ...
    \renewcommand{\axiom}{\@ifnextchar\bgroup{\ThemeAxiomCommand}{\ThemeAxiomEnvBegin}}
    \makeatother
\else
    \NewDocumentCommand{\defn}{mm+m}{
    ...
    \NewDocumentCommand{\axiom}{mm+m}{
        \ThemeRunTcbTheorem{myaxiom}{axiom}{#1}{#2}{#3}
    }
\fi
