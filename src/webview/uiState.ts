export type ToolkitSection = "style" | "presentation" | "homework" | "build" | "document" | "colors" | "setup" | "structure" | "diagnostics" | "snippets" | "sync";
...
export const TOOLKIT_SECTIONS: ToolkitSection[] = ["style", "presentation", "homework", "build", "document", "colors", "setup", "structure", "snippets", "sync", "diagnostics"];
